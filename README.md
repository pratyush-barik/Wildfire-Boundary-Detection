...
How It Works=>
1) Converts images to HSV color space for effective fire detection
2) Isolates fire-like regions using color thresholding
3) Extracts hotspot coordinates from detected regions
4) Constructs a convex hull to approximate the wildfire boundary
5) Visualizes hotspots, boundary, and affected zone automatically
